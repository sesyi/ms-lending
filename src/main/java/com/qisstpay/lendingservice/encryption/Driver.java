...
public class Driver {
    ...
    public static void main(String[] args) {
        String inputEnc;
        inputEnc = "923009510819~2022-10-21 06:52:49.878944~43981";
//        inputEnc = "923009510819:43981";
...
//        inputEnc = "https://webhook.site/ceaa39f2-6e0c-4298-8686-aa7ed92fbc9f";
        try {
            String outputEnc = Encryption.encrypt(inputEnc, Encryption.getPublicKey("/Volumes/macos - Data/QisstPay Repos/ep lending apis/subgateway.der"));
